...
* @version $Id: comprofiler.class.php 1911 2012-11-05 16:32:01Z beat $
...
function writePagesLinks($limitstart, $limit, $total,$ue_base_url,$search=null,$prefix='') {
	...
	$_PLUGINS->trigger( 'onAfterWritePagesLinks', array( &$ret, $limitstart, $limit, $total, $ue_base_url, $search, $prefix ) );
				...
				<tr>
					<td style="text-align:center" colspan="2">
						...
						<div style="text-align:left;">
							<?php echo $w; ?>
							<br/>
							<p><b>Software: Copyright 2004-2013 joomlapolis.com, MamboJoe/JoomlaJoe, Beat and CB team. This component is released under the GNU/GPL version 2 License. All copyright statements must be kept. Derivate work must prominently duly acknowledge original work and include visible online links. Official site:</b></p>
						</div>
