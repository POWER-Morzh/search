...
* @version $Id: controller.default.php 1910 2012-11-05 15:13:37Z beat $
...
function loadSampleData() {
	...
	if ( $fieldCount < 1 ) {
		...
		$groups			=	implode( ', ', $_CB_framework->acl->mapGroupNamesToValues( array( 'Public', 'Registered', 'Author', 'Editor', 'Publisher', 'Manager', 'Administrator', 'Superadministrator', 'Guest' ) ) );
		$groupPublic	=	$_CB_framework->acl->mapGroupNamesToValues( 'Public' );
		$viewaccesslevel =	1;
		$sqlStatements[3]['query'] = "INSERT INTO `#__comprofiler_lists` (`listid`, `title`, `description`, `published`, `default`, `viewaccesslevel`, `usergroupids`, `useraccessgroupid`, `sortfields`, `col1title`, `col1enabled`, `col1fields`, `col2title`, `col2enabled`, `col1captions`, `col2fields`, `col2captions`, `col3title`, `col3enabled`, `col3fields`, `col3captions`, `col4title`, `col4enabled`, `col4fields`, `col4captions`) "
					."\n VALUES (2, 'Members List', 'my Description', 1, 1, " . (int) $viewaccesslevel . ", '" . $groups . "', " . (int) $groupPublic . " , '`username` ASC', 'Image', 1, '29', 'Username', 1, 0, '42', 0, 'Other', 1, '26|*|28|*|27', 1, '', 0, '', 0)";
...
<font color="green"><b><?php echo CBTxt::T('Installation finished. Please read the included installation PDF guide <br />or visit the <a href="http://www.joomlapolis.com/cb-help-1-9-1" target="_blank">CB 1.9.1 help page</a>.'); ?> <br /><br /><?php echo CBTxt::T('Add-on CB plugins are available on'); ?> <a href="http://www.joomlapolis.com" target="_blank">www.joomlapolis.com</a>.</b></font>
</div>
<?php
		$_CB_framework->setUserState( "com_comprofiler_install", '' );
}
