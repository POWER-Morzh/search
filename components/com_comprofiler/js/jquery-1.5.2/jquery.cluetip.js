 ...
 *
*/
// search BBFIX for 2 fixes by BB
(function($) {
...
//BBFIX:
      linkWidth = $link.innerWidth();	//BFIX bug 4412
      if ( (event.type) == focus ) {
    	  // in focus event, no mouse position is available this is needed with bottomTop:		https://github.com/kswedberg/jquery-cluetip/issues/46
...
-------------------------------------- */
  ...
  // activate by focus; inactivate by blur
        ...
        $link.bind('blur.cluetip', function(event) {
          $link.attr('title', $link.data('cluetip').title);			//BBFIX: was thisInfo by error	https://github.com/kswedberg/jquery-cluetip/issues/45
          inactivate(event);
        });
  // activate by hover
      } else {
