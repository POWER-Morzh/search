...
DEFINE('_UE_INSTRUMENT03','Violoncello');
...
DEFINE('_UE_KAMMERMUSIKER','Chambermusician');
...
DEFINE('_UE_STREICHER','Strings');
DEFINE('_UE_STREICHERMITKLAVIER','Strings with Piano');
DEFINE('_UE_BLAESER','Winds');
DEFINE('_UE_BLAESERGEMISCHT','Winds Ensemble');
